...
ACTIONTREE = [['0', {'checked': 1, 'columns': {'0': "Schedule1 - Our first schedule"}, 'expanded': True, 'selected': False}],
              ['0,0', {'checked': 1, 'columns': {'0': "Action 1 - The first action of Schedule1 is executed"}, 'expanded': False, 'selected': False}],
              ['0,1', {'checked': 1, 'columns': {'0': "Action 2 - The second action of Schedule1 is executed"}, 'expanded': True, 'selected': False}],
              ['0,1,0', {'checked': 1, 'columns': {'0': "Child of Action 2 - The third action executed"}, 'expanded': False, 'selected': False}],
              ['0,2', {'checked': 1, 'columns': {'0': "Action 3 - The fourth (and last) action of Schedule1 is executed"}, 'expanded': False, 'selected': False}],
              ['1', {'checked': 1, 'columns': {'0': "Schedule2 - Another schedule"}, 'expanded': True, 'selected': False}],
              ['1,0', {'checked': 0, 'columns': {'0': "Action 1 - Action is not executed"}, 'expanded': True, 'selected': False}],
              ['1,0,0', {'checked': 1, 'columns': {'0': "Child of Action 1 - Not executed as parent (Action 1) is unchecked"}, 'expanded': False, 'selected': False}],
              ['1,1', {'checked': 1, 'columns': {'0': "Action 1 - The first (and last) of Schedule2 action to be executed"}, 'expanded': False, 'selected': False}],
              ] 
